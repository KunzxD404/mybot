...
case 'menu':
if (isBanned) return reply('*Maaf Tapi Kamu Sudah Terbanned*')
...
case 'bokep1':				 
   ...
   if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted: fstatus})
