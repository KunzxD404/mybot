...
const { WAConnection: _WAConnection ,MessageType, Presence, MessageOptions, Mimetype, WALocationMessage, WA_MESSAGE_STUB_TYPES, WA_DEFAULT_EPHEMERAL,  ReconnectMode, ProxyAgent, ChatModification, GroupSettingChange, waChatKey, mentionedJid, processTime, Browsers, } = require("@adiwajshing/baileys")
...
const { virtex10, vipi } = require('./lib/virtex.js')
...
let fakeimage = fs.readFileSync("thumbnail.jpg")
...
//====================>DATABASE<===================
let samih = JSON.parse(fs.readFileSync('./src/simi.json'))
let commandsDB = JSON.parse(fs.readFileSync('./database/bot/commands.json'))
let setiker = JSON.parse(fs.readFileSync('./src/stik.json'))
let videonye = JSON.parse(fs.readFileSync('./src/video.json'))
let audionye = JSON.parse(fs.readFileSync('./src/audio.json'))
let imagenye = JSON.parse(fs.readFileSync('./src/image.json'))
...
let nsfww = JSON.parse(fs.readFileSync('./database/group/nsfww.json'))
...
let tebakanime = JSON.parse(fs.readFileSync('./database/game/tebakanime.json'))
...
let tebaksiapaaku = JSON.parse(fs.readFileSync('./database/game/tebaksiapaaku.json'))
...
let tebakata = JSON.parse(fs.readFileSync('./database/game/tebakata.json'))
let tebaklirik = JSON.parse(fs.readFileSync('./database/game/tebaklirik.json'))
let tebakjenaka = JSON.parse(fs.readFileSync('./database/game/tebakjenaka.json'))
let tebakimia = JSON.parse(fs.readFileSync('./database/game/tebakimia.json'))
let kuismath = JSON.parse(fs.readFileSync('./database/game/kuismath.json'))
let tebaklagu = JSON.parse(fs.readFileSync('./database/game/tebaklagu.json'))
...
const sender = isGroup ? kyy.participant : kyy.key.remoteJid
const senderr = kyy.key.fromMe ? ikyy.user.jid : kyy.key.remoteJid.endsWith('@g.us') ? kyy.participant : kyy.key.remoteJid
...
const waktu = d.toLocaleDateString(locale, { hour: 'numeric', minute: 'numeric', second: 'numeric' })
...
const p1 = await ikyy.getStatus(sender)
...
ikyy.sendMessage(from, {displayname: nama, vcard: vcard}, MessageType.contact, {quoted: fstatus})
} 
...
ikyy.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('thumbnail.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}  
...
ikyy.sendMessage(from, { displayname: nama, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
}
...
const checkATMuser = (sender, _uang) => {
        	let position = false
...
fs.writeFileSync("./database/game/tebaklagu.json", JSON.stringify(tebaklagu))
}
}
...
fs.writeFileSync("./database/game/kuismath.json", JSON.stringify(kuismath))
}
}
...
tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR`
ind = {
...
let ikyads = await getBuffer(`https://i.ibb.co/4m4jq9C/ea64e685d11d.jpg`)
let virgam = fs.readFileSync(`./src/images/virgam.jpeg`)
fakelink = (tekslink) => { 
return {"externalAdReply": { "title": tekslink, "thumbnail": ikyads, "sourceUrl": "https://wa.me/6287778886786" }}
}
...
buttons = [{buttonId: '!sc',buttonText:{displayText: 'SC BOT'},type:1},{buttonId:'!infoig',buttonText:{displayText:'INSTAGRAM'},type:1}]
buttonsMessage = {
contentText: `${txtt}`,
...
ikyy.sendMessage(from, { "degreesLatitude": '', "degreesLongitude": '', "jpegThumbnail": fakeimage}, MessageType.location, {quoted: ikykyyyy})
break
case 'kalender':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(sessionMenu(prefix))
break
case 'photoxy': case 'photoxymenu':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(photoxyMenu(prefix))
break
case 'ephoto': case 'ephotomenu':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(ephotoMenu(prefix))
break
case 'groupmenu': case 'grupmenu': case 'menugroup':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(groupMenu(prefix))
break
case 'storymenu': case 'moviemenu':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
break
case 'bugmenu': case 'menuwar': case 'warmenu':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(warMenu(prefix))
break
case 'wibumenu': case 'menuwibu':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(wibuMenu(prefix))
break
...
break
case 'cecanmenu': case  'menucecan':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(cecanMenu(prefix))
break
case 'asupanmenu': case  'menuasupan':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(asupanMenu(prefix))
break
case 'storagemenu': case 'menustorage':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(storageMenu(prefix))
break
...
break
case 'pornmenu': case  '181+':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(pornMenu(prefix))
break
case 'imagemenu': case 'imageefek':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(imageMenu(prefix))
break
case 'urlmenu': case 'linkmenu':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(urlMenu(prefix))
break 
case 'islammenu': case 'islamimenu':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(islamMenu(prefix))
break
case 'mutualmenu':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
reply(mutualMenu(prefix))
break
...
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
buff = await getBuffer(`https://leyscoders-api.herokuapp.com/api/quote-maker?text=${q}&apikey=${lolkey}`)
...
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/wiki?kata=${q}&apikey=${lolkey}`)
ikyy.sendMessage(from, `「 RESULT FOUND 」\n• Hasil Pencarian Dari: ${anu.result.from}\n• Hasil: ${anu.hasil}`, text, {quoted: fstatus})
break
  case 'wanted':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
   list = []
   listmenu = [`allpay`,`gopay`,`dana`]
   listmenuu = [`QR ALLPAY`,`QR GOPAY`,`QR DANA`]
   nombor = 1
   startnum = 0
   for (let x of listmenu) {
   const yy = {title: 'menu ke' + nombor++,
...
list.push(yy)
   ...
   listmsg(from, `KALO MAU VIA NO HUBUNGI OWNER😗`, `  `, list)
   break
...
ikyy.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, quoted: fstatus})
fs.unlinkSync(ran)
})
break
case 'stickerlist':
...
delb = await ikyy.downloadMediaMessage(boij)
imagenye.push(`${svst}`)
fs.writeFileSync(`./src/images/${svst}.jpeg`, delb)
fs.writeFileSync('./src/images.json', JSON.stringify(imagenye))
...
buffer = fs.readFileSync(`./src/images/${namastc}.jpeg`)
...
ikyy.sendMessage(from, teks.trim(), extendedText, {  quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_SelfBot OnlyDev City_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JStw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('thumbnail.jpg')} }}, contextInfo: { "mentionedJid": videonye } })
break
case 'fast':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
if (err) return reply('Error!')
hah = fs.readFileSync(ran)
ikyy.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, quoted: kyy})
fs.unlinkSync(ran)
})
} catch (e) {
reply(mess.error.api)
...
if (err) return reply('Error!')
hah = fs.readFileSync(ran)
ikyy.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt: true, quoted: fvn})
fs.unlinkSync(ran)
})
break
case 'sound1':
...
ikyy.sendMessage(from, sound1, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: fstatus})
break                          
case 'sound2':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
const sound2 = fs.readFileSync('./assets/sound2.mp3')
ikyy.sendMessage(from, sound2, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: fstatus})
break 
case 'sound3':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
const sound3 = fs.readFileSync('./assets/sound3.mp3')
ikyy.sendMessage(from, sound3, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: fstatus})
break 
case 'sound4':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
const sound4 = fs.readFileSync('./assets/sound4.mp3')
ikyy.sendMessage(from, sound4, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: fstatus})
break      
case 'sound5':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
const sound5 = fs.readFileSync('./assets/sound5.mp3')
ikyy.sendMessage(from, sound5, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: fstatus})
break           
case 'desah':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
const desahan4 = fs.readFileSync('./assets/desahan4.mp3')
ikyy.sendMessage(from, desahan4, audio, { mimetype: 'audio/mp4', duration: 999999999, ptt: true, quoted: fstatus})
break
...
fs.writeFileSync(`./src/${from}.json`, JSON.stringify(gelutSkuy, null, 2))
...
sendButMessage(from, titid, `Klik Untuk Ke Game Selanjutnya`, [{ buttonId: `${prefix}family100`, buttonText: { displayText: `⬡ NEXT `, }, type: 1,
},]);
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  reply('*+* ```Tebak Lagu```\n\n• *Petunjuk* :'+kisi_kisi+'\n• *Waktu* : 30s')
  ikyy.sendMessage(from, ini_buffer, audio, {quoted: fstatus}).then(() => {
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  ikyy.sendMessage(from, '*+* ```Tebak Tebakan```\n\n• *soal* :'+pertanyaan+'\n• *kisi²* :'+kisi_kisi, text, { quoted: fstatus}).then(() => {
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  ikyy.sendMessage(from, '*+* ```Tebak Kata```\n\n• *Soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: fstatus}).then(() => {
...
tagq = `@${nomqm.split('@')[0]}` 
ikyy.sendMessage(from, tagq, text, { quoted: fstatus, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [nomqm]}})
break
case 'tagme':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
var nomqm = kyy.participant
tagu = `@${nomqm.split('@s.whatsapp.net')[0]}`
ikyy.sendMessage(from, tagu, text, { quoted: fstatus, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [nomqm]}})
break
case 'report':
case 'bugreport':
case 'bug':
...
const teks1 = `Report\nNomor : @${num.split("@s.whatsapp.net")[0]}\nPesan : ${pesan}`
var options = {
text: teks1,
contextInfo: { mentionedJid: [num] },
}
ikyy.sendMessage(`6287778886786@s.whatsapp.net`, options, text, { quoted: fstatus })
...
profilePic = 'https://i.ibb.co/WG4Y3gm/752dd56dd663.jpg'
}
...
ikyy.sendMessage(from, buffer, image, { caption: teks, quoted: fstatus})
break
case 'leaderboard': 
case 'leaderboards':
if (isBanned) return reply(mess.Ban)
...
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
ikyy.sendMessage(from, rulesBot(prefix), MessageType.text, {quoted: fstatus})
break
case 'runtime':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
res = await ikyy.query({json: ["query", "invite", code],
expect200: true})
caption = `「 *GROUP LINK INSPECTOR* 」 

♤⃟♣️❱*Nama Grup : ${res.subject}*
♤⃟♣️❱*Di Buat Oleh : wa.me/${res.id.split('-')[0]}*
♤⃟♣️❱*ID Grup : ${res.id}*
♤⃟♣️❱*Edit Info Grup : ${res.restrict?`Hanya admin`:`Semua peserta`}*
♤⃟♣️❱*Kirim Pesan : ${res.announce?`Hanya admin`:`Semua peserta`}*
♤⃟♣️❱*Pesan Sementara : ${res.ephemeralDuration?`Aktif`:`mati`}*
♤⃟♣️❱*Jumlah Member : ${res.size}*
♤⃟♣️❱Deskripsi :
${res.desc ? `${res.desc}` : 'Gada'}`
try {
profilePic = await ikyy.getProfilePicture(res.id)
} catch {
profilePic = `${imagebb}`
}
anay = await getBuffer(profilePic)
ikyy.sendMessage(from, anay, image, {quoted: kyy, thumbnail: fs.readFileSync('thumbnail.jpg'), caption: caption, })
} catch (e) {
reply(`${e}`)
}
break
...
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  menu =`Mau Donasi Pake Apa Kak😯`
   buttons =  [{buttonId: `${prefix}allpay`, buttonText: {displayText: 'Qr Allpay'}, type: 1},{buttonId: `${prefix}gopay`, buttonText: {displayText: 'Qr Gopay'}, type: 1},{buttonId: `${prefix}dana`, buttonText: {displayText: 'Qr Dana'}, type: 1}]
   ...
   buttonsMessage = { contentText: `${menu}`, footerText:  `Donasi Nya Via Qr Ya Kak😄`, imageMessage: imageMsg,buttons: buttons,headerType: 1}
...
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
allpaynya = 'https://i.ibb.co/MhB8L4q/c6e6f5c091f1.jpg'
buff = await getBuffer(allpaynya)
teksnya = `Caranya :
1. Buka Aplikasi GOPAY/DANA via HP-mu.
2. Pilih Pay / Bayar
3. Scan Barcode diatas
...
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
dananya = 'https://i.ibb.co/HPSVMqV/52379c8c43e0.jpg'
buff = await getBuffer(dananya)
teksnya = `Caranya :
...
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
gopeynya = 'https://i.ibb.co/GTM0Ptw/970e3ed75ad3.jpg'
buff = await getBuffer(gopeynya)
teksnya = `Caranya :
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  ss = await getBuffer(`https://api.apiflash.com/v1/urltoimage?access_key=86951200d52c4e2eafa6b5a43a857939&url=http://google.com/search?q=${q}&oq={q}&aqs=chrome..69i57j0i433i512l2j0i512l2.858j0j4&ikyy=ms-android-oppo&sourceid=chrome-mobile&ie=UTF-8`)
  reply(mess.wait)
...
*Data Berhasil Didapatkan!*
♤⃟♣️❱Nama : ${res[0].nama}
♤⃟♣️❱Ukuran : ${res[0].size}
♤⃟♣️❱Link : ${res[0].link}

_*Tunggu Proses Upload Media......*_`
 reply(result)
 sendFileFromUrl(res[0].link, document, {mimetype: res[0].mime, filename: res[0].nama, quoted: fstatus})
 break
case 'tt':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/facebook-dl?url=${q}&apikey=${lolkey}`)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
 ...
 ikyy.sendMessage(from, buffer, image, {caption: xixixai, quoted: fstatus})
 } catch (e) {
 console.log(e)
 reply(String(e))
}
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  get_result = get_result.result
  ini_txt = `♤⃟♣️❱Title : ${get_result.anime}\n`
  ini_txt += `♤⃟♣️❱Porducers : ${get_result.producers}\n`
  ini_txt += `♤⃟♣️❱Duration : ${get_result.duration}\n`
  ini_txt += `♤⃟♣️❱Size : ${get_result.size}\n`
  ini_txt += `♤⃟♣️❱Sinopsis : ${get_result.sinopsis}\n`
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  ini_txt = ""
  for (var x of get_result) {
  ini_txt += `♤⃟♣️❱Title : ${x.title}\n`
  ini_txt += `♤⃟♣️❱Link : ${x.link}\n`
  ini_txt += `♤⃟♣️❱Thumbnail : ${x.thumbnail}\n\n`
}
  reply(ini_txt)
  break
case 'neko':
 ...
 *♤⃟♣️❱Diupload Pada :* ${res.all[0].ago}
 *♤⃟♣️❱Views :* ${res.all[0].views}
 *♤⃟♣️❱Durasi :* ${res.all[0].timestamp}
 *♤⃟♣️❱Channel :* ${res.all[0].author.name}
 *♤⃟♣️❱ Link Channel :* ${res.all[0].author.url}
...
sendFileFromUrl(res[0].link, audio, {quoted: fvn, mimetype: 'audio/mp4', filename: res[0].output})
}
if (teks.endsWith("-doc")){
...
sendFileFromUrl(res[0].link, document, {quoted: fstatus, mimetype: 'audio/mp3', filename: res[0].output})
}
break
case 'play2':   
...
teks += `♤⃟♣️❱Nama : ${get_data[i].name}
♤⃟♣️❱Harga : ${get_data[i].harga}
♤⃟♣️❱Terjual : ${get_data[i].terjual}
♤⃟♣️❱Lokasi : ${get_data[i].location}
♤⃟♣️❱Deskripsi*: ${get_data[i].desc}
♤⃟♣️❱Stok : ${get_data[i].stock}
♤⃟♣️❱Informasi : ${get_data[i].information}
...
teks += `♤⃟♣️❱Title : ${get_result[i].title}
♤⃟♣️❱Harga : ${get_result[i].price}
♤⃟♣️❱Rate : ${get_result[i].rating}
♤⃟♣️❱Link : ${get_result[i].url}
...
♤⃟♣️❱Views : ${i.views}
♤⃟♣️❱Upload : ${i.ago}
♤⃟♣️❱Durasi : ${i.timestamp}
♤⃟♣️❱Channel : ${i.author.name}
♤⃟♣️❱Link : ${i.url}`
}
   b = a.trim()
   sendFileFromUrl(res.all[0].image, image, {quoted: fstatus, caption: b})
   } catch (e) {
   console.log(e)
   reply(`${e}`)
}
...
await ikyy.sendMessage(from, get_buffer, image, { quoted: fstatus, caption: ini_txt })
break
case 'cuaca':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
await ikyy.sendMessage(from, { degreesLatitude: get_result.latitude, degreesLongitude: get_result.longitude }, location, { quoted: fstatus })
reply(ini_txt)
break
case 'covidindo':
if (isBanned) return reply(mess.Ban)
...
*Data Berhasil Didapatkan!*
♤⃟♣️❱Username : ${ini_result.name}
♤⃟♣️❱Public Repo : ${ini_result.public_repos}
♤⃟♣️❱Public Gists : ${ini_result.public_gists}
♤⃟♣️❱Pengikut : ${ini_result.followers}
♤⃟♣️❱Following : ${ini_result.following}
♤⃟♣️❱Mengikuti : ${ini_result.bio}
♤⃟♣️❱Link : ${ini_result.url}
`
...
*Data Berhasil Didapatkan!*
♤⃟♣️❱Username : ${ini_result.username}
♤⃟♣️❱Nama : ${ini_result.fullname}
♤⃟♣️❱Pengikut : ${ini_result.followers}
♤⃟♣️❱Mengikuti : ${ini_result.following}
♤⃟♣️❱Deskripsi : ${ini_result.bio}
♤⃟♣️❱Link : https://instagram.com/${ini_result.username}
`
 ikyy.sendMessage(from, ini_buffer, image, { caption: ini_txt, thumbnail: Buffer.alloc(0) })
 break
  case 'stalktiktok':
...
*Data Berhasil Didapatkan!*
♤⃟♣️❱Username : ${get_result.username}
♤⃟♣️❱Nama : ${get_result.nickname}
♤⃟♣️❱Pengikut : ${get_result.followers}
♤⃟♣️❱Mengikuti : ${get_result.followings}
♤⃟♣️❱Likes : ${get_result.likes}
...
ikyy.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: fstatus})
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  ikyy.sendMessage(from, buffer, sticker)
  break
case 'triggered':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
if (error) return reply(mess.error.api)
ikyy.sendMessage(from, fs.readFileSync(`./sticker/triggered.webp`), sticker, {quoted: fstatus})
...
const media = await ikyy.downloadAndSaveMediaMessage(encmedia, `./sticker/${sender}`)
await ffmpeg(`${media}`)
.input(media)
.on('start', function (cmd) {
console.log(`Started : ${cmd}`)
...
.toFormat('webp')
.save(`./sticker/${sender}.webp`)
} else if ((isMedia && kyy.message.videoMessage.fileLength < 10000000 || isQuotedVideo && kyy.message.extendedTextMessage.contextInfo.quotedMessage.videoMessage.fileLength < 10000000)) {
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
 ...
 .on('error', (e) => {
  console.log(e)
  ikyy.sendMessage(from, 'Terjadi kesalahan', 'conversation', { quoted: fstatus })
  fs.unlinkSync(media)
})
 .on('end', () => {
_out = getRandom('.webp')
 ...
 .on('exit', () => {
  ikyy.sendMessage(from, fs.readFileSync(_out),'stickerMessage', { quoted: fstatus })
  fs.unlinkSync(out)
  fs.unlinkSync(_out)
  fs.unlinkSync(media)
})
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  ikyy.sendMessage(from, buffer, image, {quoted: fstatus, caption: 'Nih'})
  fs.unlinkSync(ran)
})
  break
case 'smeme': 
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
   ...
   ikyy.sendMessage(from, mp4, video, {mimetype: 'video/gif', quoted: fgif, caption: mess.success})
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
   ...
   reply(mess.wait)
   encmedia = JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
   mediaaa = await ikyy.downloadAndSaveMediaMessage(encmedia)
   a = await webp2gifFile(mediaaa)
   mp4 = await getBuffer(a.result)
   ikyy.sendMessage(from, mp4, video, {mimetype: 'video/mp4', quoted: fstatus, caption: mess.success})
   fs.unlinkSync(mediaaa)
   } else {
   reply(mess.wrongFormat)
}
...
${bold}😈 Speed : ${latensie.toFixed(4)} _Second_${bold}
😈 Active Time : ${kyun(uptime)}
${bold}😈 Pengguna : ${_registered.length} _Pengguna_${bold}
${bold}😈 Hit Today : ${hit_today.length}${bold}
${bold}😈 Hit All : ${hitall}${bold}

${bold}PHONE STATISTICS${bold}

${bold}😈 Ram Usage : ${ram2}${bold}
${bold}😈 Platform : ${os.platform()}${bold}
${bold}😈 Hostname : ${os.hostname()}${bold}
${bold}😈 Uptime : ${runtime(process.uptime())}${bold}
${bold}😈 Wa Version: ${ikyy.user.phone.wa_version}${bold}
${bold}😈 Os Version: ${ikyy.user.phone.os_version}${bold}
${bold}😈 Device Manufacturer: ${ikyy.user.phone.device_manufacturer}${bold}
${bold}😈 Device Model: ${ikyy.user.phone.device_model}${bold}
${bold}😈 Os Build Number: ${ikyy.user.phone.os_build_number}${bold}

${bold}CONNECT WITH ME${bold}

${bold}⚫ Api : kunz-api.herokuapp.com${bold}
${bold}⚫ Github : github.com/KunzxD404${bold}
...
const encmedia = isQuotedAudio ? JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kyy
buff = await ikyy.downloadMediaMessage(encmedia)
for (let _ of anu) {
ikyy.sendMessage(_.jid, buff, audio, { quoted: fstatus })
}
} else if (isMedia && !kyy.message.videoMessage || isQuotedSticker) {
...
buff = await ikyy.downloadMediaMessage(encmedia)
for (let _ of anu) {
ikyy.sendMessage(_.jid, buff, sticker, { quoted: fstatus, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
} else{
...
encmedia = JSON.parse(JSON.stringify(kyy).replace('quotedM','m')).message.extendedTextMessage.contextInfo
mediau = await ikyy.downloadAndSaveMediaMessage(encmedia)
...
var org = pc.split("|")[1];
ikyy.sendMessage(nomor+'@s.whatsapp.net', org, MessageType.text)   
...
ikyy.blockUser (`${ny}@c.us`, "add")
reply(`Nomor ${ny} telah di blockir!`)
} else {
ny = `${mentionUser}`
ikyy.blockUser (`${ny.replace("@s.whatsapp.net","@c.us")}`, "add")
...
if (kyy.message.extendedTextMessage === undefined || kyy.message.extendedTextMessage === null) {
ny = `${args[0].replace('@', '')}@c.us`
ikyy.blockUser (`${ny}@c.us`, "remove")
reply(`Nomor ${ny} telah di unblockir!`)
} else {
ny = `${mentionUser}`
ikyy.blockUser (`${ny.replace("@s.whatsapp.net","@c.us")}`, "remove")
...
ikyy.sendMessage(from, yeh, text, { quoted: fstatus })
break  
case 'totag':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
if ((isMedia && !kyy.message.videoMessage || isQuotedSticker) && args.length == 0) {
encmediau = isQuotedSticker ? JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kyy
file = await ikyy.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
value = args.join(" ")
...
fs.unlinkSync(file)
} else if ((isMedia && !ikyy.message.videoMessage || isQuotedImage) && args.length == 0) {
encmediau = isQuotedImage ? JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kyy
file = await ikyy.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
value = args.join(" ")
var group = await ikyy.groupMetadata(from)
var member = group['participants']
...
fs.unlinkSync(file)
} else if ((isMedia && !ikyy.message.videoMessage || isQuotedAudio) && args.length == 0) {
encmediau = isQuotedAudio ? JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kyy
file = await ikyy.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
value = args.join(" ")
var group = await ikyy.groupMetadata(from)
var member = group['participants']
...
fs.unlinkSync(file)
 } else if ((isMedia && !ikyy.message.videoMessage || isQuotedVideo) && args.length == 0) {
...
fs.unlinkSync(file)
} else if ((isMedia && !ikyy.message.videoMessage || isQuotedDocument) && args.length == 0) {
encmediau = isQuotedDocument ? JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kyy
file = await ikyy.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
value = args.join(" ")
var group = await ikyy.groupMetadata(from)
var member = group['participants']
...
ini_buffer = fs.readFileSync(file)
ikyy.sendMessage(from, ini_buffer, document, options)
fs.unlinkSync(file)
}  else if ((isMedia && !ikyy.message.videoMessage || isQuotedVideo) && args.length == 0) {
encmediau = isQuotedVideo ? JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kyy
file = await ikyy.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
   ...
   list = []
   com = [`opengc`,`leveling 1`,`welcome 1`,`antilink 1`,`antiwame 1`,`mute 1`]
   comm = [`closegc`,`leveling 0`,`welcome 0`,`antilink 0`,`antiwame 0`,`mute 0`]
   listnya = [`Group buka/tutup`,`Leveling 1/0`,`Welcome 1/0`,`Antilink 1/0`,`Antiwame 1/0`,`Mute 1/0`]
   suruh = [`1`, `0`]
   fiturname = [`Group`,`Leveling`,`Welcome`,`Antilink`,`Antiwame`,`Mute`]
...
if (!isGroup) return reply(mess.only.group)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
if (kyy.message.extendedTextMessage === undefined || kyy.message.extendedTextMessage === null) return reply('Tag Orang Nya Kak')
mentioned = kyy.message.extendedTextMessage.contextInfo.mentionedJid
...
response = await ikyy.groupAdd(from, [entah])
...
if (!isGroupAdmins && !isOwner && !kyy.key.fromMe) return reply(mess.only.admin)
if (!isBotGroupAdmins) return 
if (kyy.message.extendedTextMessage === undefined || kyy.message.extendedTextMessage === null) return reply('𝗧𝗮𝗴 𝘁𝗮𝗿𝗴𝗲𝘁 𝘆𝗮𝗻𝗴 𝗶𝗻𝗴𝗶𝗻 𝗱𝗶 𝘁𝗲𝗻𝗱𝗮𝗻𝗴!')
mentioned = kyy.message.extendedTextMessage.contextInfo.mentionedJid
if (mentioned.length > 1) {
dem = ''
for (let _ of mentioned) {
...
ikyy.groupMakeAdmin(from, members_id)
break
case 'leave':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
kyyi = anu.result
sendButMessage(from, kyyi, `Klik Untuk Ke Quotes Selanjutnya`, [{buttonId: `${prefix + command}`,buttonText: {displayText: `⬡ NEXT `,},type: 1,},]);
break;
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  ikyy.sendMessage(from, cita2, audio,{mimetype: 'audio/mp4', ptt:true, quoted: fstatus})
  break
...
*Z*
Zambia 260
Zimbabwe 263`, text, { quoted: fstatus})
break
case 'togel':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
   ...
   linkpp = await ikyy.getProfilePicture(mberr) || "https://telegra.ph/file/40151a65238ba2643152d.jpg"
   buffer = await getBuffer(linkpp)
   ikyy.sendMessage(from, buffer, image, { quoted: fstatus, caption: `Profile Picture of @${mberr.split("@")[0]}`, contextInfo: { "mentionedJid": [mberr] }})
}
   break
case 'd':
case 'del':
...
ikyy.sendMessage(from, teks, text, {quoted: fstatus})
break
case 'readall':
if (isBanned) return reply(mess.Ban)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
...
reply(`Berhasil membaca ${read.length} Chat !`)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fstatus})
  ...
  if (isAntiLink) return reply(`Udah aktif`)
  antilink.push(from)
  fs.writeFileSync('./database/group/antiwame.json', JSON.stringify(antilink))
...
nsfww.push(from)
fs.writeFileSync('./database/group/nsfww.json', JSON.stringify(nsfww))
...
let scen = await ikyy.sendMessage(from, fs.readFileSync(`./jadibot@${sender}.jpg`), MessageType.image, {quoted : kyy,caption: 'Scan QR ini untuk jadi bot sementara!\n1. Klik titik tiga di pojok kanan atas\n2. Ketuk WhatsApp Web\n3. Scan QR ini \n\nQR Expired dalam 20 detik'})    
setTimeout(() => {
...
ikyy.on ('open', async () => {
  ...
  const authInfo = ikyy.base64EncodedAuthInfo()
  fs.writeFileSync(`./src/${sender}.json`, JSON.stringify(authInfo  ,null, '\t'))
  await ikyy.sendMessage('0@s.whatsapp.net', `Kamu bisa login tanpa qr dengan pesan dibawah ini`, MessageType.extendedText)
  ikyy.sendMessage('0@s.whatsapp.net', `${prefix + command} ${Buffer.from(JSON.stringify(authInfo)).toString('base64')}`, MessageType.extendedText)
})
ikyy.on('chat-update', async (chat) => {
require('./iky.js')(ikyy, chat)
})    
await ikyy.connect().then(async ({user}) => {
...
if (args.length < 1) return reply('Teksnya?')
teks = body.slice(10)
ikyy.sendMessage('status@broadcast', teks, MessageType.text)
...
if (args.length < 1) return reply('Teksnya?')
teks = body.slice(12)
ikyy.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`${NamaBot}`}, MessageType.location)
...
const encmedia = isQuotedSticker ? JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kyy
buff = await ikyy.downloadMediaMessage(encmedia)
ikyy.sendMessage('status@broadcast', buff, sticker)
}
...
const encmedia = isQuotedAudio ? JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kyy
buff = await ikyy.downloadMediaMessage(encmedia)
ikyy.sendMessage('status@broadcast', buff, audio, {mimetype: 'audio/mp4', duration: 359996400})
}
...
const encmedia = isQuotedAudio ? JSON.parse(JSON.stringify(kyy).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kyy
buff = await ikyy.downloadMediaMessage(encmedia)
ikyy.sendMessage('status@broadcast', buff, audio, {mimetype: 'audio/mp4', duration: 359996400, ptt: true})
}
...
reply(mess.wait)
var enmediap = JSON.parse(JSON.stringify(kyy).replace('quotedM','m')).message.extendedTextMessage.contextInfo
var mediap = await ikyy.downloadAndSaveMediaMessage(enmediap)
const buffer3 = fs.readFileSync(mediap)
ikyy.sendMessage('status@broadcast', buffer3, MessageType.video, {duration: 359996400, caption: `${konti}`})
...
reply(mess.wait)
enmedia = JSON.parse(JSON.stringify(kyy).replace('quotedM','m')).message.extendedTextMessage.contextInfo
media = await ikyy.downloadAndSaveMediaMessage(enmedia)
const buffer6 = fs.readFileSync(media)
ikyy.sendMessage('status@broadcast', buffer6, MessageType.video, {mimetype : 'video/gif', caption: `${konti}`})
...
ikyy.sendMessage('status@broadcast', buffer, MessageType.image, {quoted: kyy, caption: `${teksyy}`})
...
case 'infogithub':
reply(`Jangan Lupa Follow Github Ya : https://github.com/KunzxD404`)
break
case 'infoig':
reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/iam_kunzx`)
break
case 'ikyygroup':
case 'groupbot':
case 'botgroup':
reply(`*Kunz Botz Group*\n*https://chat.whatsapp.com/GDZOBuMkFSCKw6mzDUDoPd*\n\n*Kunz Botz Group²*\n*https://chat.whatsapp.com/G64dsAUKQFx4QO8n9dBybj*`)
break                    
case 'readmore':
case 'more':
reply('‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎')
...
virgamm = await ikyy.downloadAndSaveMediaMessage(virgamnye, './src/images/')
ran = getRandom('.png')
...
buffer = fs.readFileSync(ran)
ikyy.sendMessage(from, buffer, image, {quoted: fstatus, thumbnail:virgam, caption: 'Nih Fotonya\n\n⚠️*Perhatian.!!*⚠️\nFoto ini Mengandung Virgam/Bug SW!!\nTeruskan Gambar ini ke Target/jadikan SW'})
fs.unlinkSync(ran)
})
break
case 'tovirvid' : 
...
ini_buffer = fs.readFileSync(file)
ikyy.sendMessage(from, ini_buffer, video, {quoted: fstatus, thumbnail:virgam, caption: 'Nih Videonya\n\n⚠️Perhatian.!!⚠️\nVideo ini Mengandung Virvid/Bug SW!!'}, options)
fs.unlinkSync(file)
} else{
