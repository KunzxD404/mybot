...
let buffer = await getBuffer(`http://hadi-api.herokuapp.com/api/card/welcome?nama=${num.split('@')[0]}&descriminator=${mdata.participants.length}&memcount=${mdata.participants.length}&gcname=${mdata.subject}&pp=${ppimg}&bg=https://telegra.ph/file/ec7859cd2bc54b8d6b313.jpg`)
